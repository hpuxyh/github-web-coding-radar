...
export const projects = [
  {
    ...
    preview: {
      title: '选一个项目照着改',
      subtitle: '找项目、看改法、复制给 AI、晒作品',
      items: ['适合新手', '主要改哪里', '复制给 AI', '展示作品'],
    },
    summary:
      '帮你先挑适合新手的 GitHub 项目，再一步步改成个人主页、清单页面或选择工具。',
    details:
      '页面用白话说明这个项目能改成什么、你要准备什么、主要改哪里、哪些地方先别碰，还能复制一段话给 AI 帮你改。',
    techIntro:
      '先用静态页面验证“找项目、照着改、做完展示”这条路能不能跑通，后续再接真实项目和公开作品审核。',
    tags: ['新手可用', '复制给 AI', '网页作品', '案例展示'],
    accent: '#1769c2',
    featured: true,
  },
  {
    ...
    techIntro:
      '先从每天找项目和白话解释开始，再逐步增加照着改、复制给 AI、作品展示这些能力。',
